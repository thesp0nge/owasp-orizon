...
public class OrizonParseException extends Exception {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1031052296940901056L;
	private String messString;
	
	public OrizonParseException(String message) {
	...
	public String getMessage() {
		return "[ORIZON] Exception during source parsing: " + messString;
	}
}
