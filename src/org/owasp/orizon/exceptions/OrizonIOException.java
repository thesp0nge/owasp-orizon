...
public class OrizonIOException extends Exception {

	private static final long serialVersionUID = -3823847049869924086L;
	private String errorMessage;
	private int errorCode;

	public OrizonIOException(String msg, int code) {
		super();
		errorMessage = msg;
		errorCode = code;
	}
	...
	public String getMessage() {
		return "[ORIZON] IOException: " + errorMessage;
	}
}
